...
class AppController extends Controller
{
    ...
    public function initialize(): void {
        ...
        foreach($components as $component){
            if ($component === 'RequestHandler') {
                $this->loadComponent($component, ['enableBeforeRedirect' => false]);
            } else {
	...
	public function beforeFilter(EventInterface $event){
		...
		//26-10-2021 by Amol
		//header("Report-To {'group':'default','max_age':31536000,'endpoints':[{'url':'https://agmarkonline.dmi.gov.in/DMI4.2/users/csp_report'}]}");
		//header("Content-Security-Policy-Report-Only: script-src 'self'; report-to default; report-uri https://agmarkonline.dmi.gov.in/DMI4.2/users/csp_report");
		...
		// #12 : Appeal Application (APL)  [LIVE : 21-2-2024]
		// #13: Laboratory Export Renewal [LIVE : 01-12-2023]
		$this->Session->write('applTypeArray',array('1','2','3','4','5','6','8','9','10','11','12','13'));
