...
class InspectionsController extends AppController{
    ...
    private $DmiSurrenderSmsEmailTemplates;
    private $DmiTempEsignStatuses;
    private $MCommodity;
	...
	public function beforeFilter($event) {
		...
		if($this->Session->read('username') == null){
			...
			$user_access = $DmiUserRoles->find('all',array('conditions'=>array('OR'=>array('io_inspection'=>'yes','form_verification_home'=>'yes','super_admin'=>'yes','dy_ama'=>'yes','jt_ama'=>'yes','ama'=>'yes'),'user_email_id'=>$this->Session->read('username'))))->first();
    ...
    private function loadAllModels(): void {
		...
		$this->DmiSurrenderSmsEmailTemplates = $this->AqcmsWrapper->customeLoadModel('DmiSurrenderSmsEmailTemplates');
		$this->DmiTempEsignStatuses = $this->AqcmsWrapper->customeLoadModel('DmiTempEsignStatuses');
	...
	public function findLatestSiteinspectionReportPdf($customer_id,$report_section_details){
		...
		if(!empty($report_pdf_model)){
            ...
            $report_pdf_model = $this->AqcmsWrapper->customeLoadModel($report_pdf_model);
