...
class DmiLaboratoryOtherDetailsTable extends Table {
	...
	public function saveFormDetails($customer_id,$forms_data) {
		...
		if ($dataValidatation == 1 ) {
			...
			//this line added on 21-02-2024 by Amol
			$nabl_accreditated_upto_date= new \DateTime($nabl_accreditated_upto);
			...
			$newEntity = $this->newEntity(array(
				...
				'nabl_accreditated_upto'=> $nabl_accreditated_upto_date->format('Y-m-d'))); //this line updated on 21-02-2024 by Amol
