  ...
  // <!-- //display date in dd/mm/yyyy format added by shankhpal on 12/12/23 -->
            	...
            	echo "<td>" . $Commodityname . "</td>";
           		echo "<td>" . $eachrow['lotno'] . "</td>";
							echo "<td>" . date('d/m/Y', strtotime($eachrow['datesampling'])) . "</td>";
							echo "<td>" . date('d/m/Y', strtotime($eachrow['dateofpacking'])) . "</td>";
...
<table width="100%" border="1">
	...
	<table class="table "  border="1">
			<tr>
				<td style="padding:10px; vertical-align:top;">Other Upload Docs:<?php if(!empty($form_fields_details['other_upload_docs'])){ ?><a id="" target="blank" href="<?php echo str_replace("D:/xampp/htdocs","",$form_fields_details['other_upload_docs']); ?>"><?=$str2 = substr(array_values(array_slice((explode("/",$form_fields_details['other_upload_docs'])), -1))[0],23);?></a>
