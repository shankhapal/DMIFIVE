								...
								<div class="form-horizontal">
									<div class="card-body">
										<div class="row">
											<div class="col-sm-6">
												<div class="form-group row">
													<label for="inputEmail3" class="col-sm-4 col-form-label">AGMARK Certificate No. <span class="cRed">*</span></label>
													<div class="col-sm-8">
                                            ...
                                            <!--New block is added on 19-01-2024 by Amol, to manage hide/show Nabl date and grant date option for lab. export -->
