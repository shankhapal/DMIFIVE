...
<?php if($_SESSION['is_training_completed'] == 'no'){ ?>
	...
	<table class="table table-bordered">
        ...
        <tr>
            ...
            <td><?php echo $_SESSION['f_name']." ".$_SESSION['l_name'] ;?></td>
            <!-- application pdf added by laxmi on 31-08-2023 -->
            <td>
                <?php if(!empty($chemist_appl_pdf_file)){ ?>
                    <a href="<?php echo $chemist_appl_pdf_file; ?>" target="_blank">View PDF <i class="far fa-file-pdf"></i></a>
                <?php } else { echo "<span class='badge badge-dark'>N/A</span>"; } ?>
            </td>
            <td>
                <!-- training schedule letter from RO added by laxmi B. on 30-12-2022-->
                <?php if(!empty($pdf_file)){ ?> <a href="<?php echo $pdf_file; ?>" target="_blank">Training Schedule At RAL</a><?php } else { echo "<span class='badge badge-success'>In Process</span>"; } ?>
            ...
            <td>
                ...
                <?php if(!empty($ral_letter)){ ?><a href="<?php echo $ral_letter; ?>" target="_blank">Reliving Letter From RAL</a><?php } else { echo "<span class='badge badge-success'>In Process</span>"; } ?>
            ...
            <td>
                ...
                <?php if(!empty($certificate)){ ?><a href="<?php echo'../../'.$certificate; ?>" target="_blank">Grant Certificate</a><?php } else { echo "<span class='badge badge-success'>In Process</span>"; } ?>
            </td>
    ...
    <div id="myModal" class="modal">
        <div class="modal-content">
            <div class="modal-header"><h4>Withdraw Application of Chemist Training</h4><span class="close">&times;</span></div>
                ...
                <table id="rej-appl-table" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <?php  echo $this->Form->create(null, array( 'enctype'=>'multipart/form-data', 'id'=>'rejectApp','class'=>'form_name'));  ?>
                            ...
                            <td>
                                <?php echo $this->Form->control('application_id', array('type'=>'text', 'readonly'=>true, 'class'=>'cvOn cvReq cvAlphaNum chemistId ', 'value' =>$_SESSION['username'], 'label'=>false)) ;?>
                            </td>
                            <td>
                                <?php  echo $this->Form->control('remark', array('type'=>'textarea', 'id'=>'remark', 'escape'=>false,  'placeholder'=>'Enter Remark/Reason', 'value'=>'','class'=>'cvOn cvReq cvAlphaNum reject',   'label'=>false)); ?>
                                <div><b class="errorClass text-red"></b></div>
                            </td>
...
<?php }
    ...
    echo $this->Html->css('chemist/reject_application');
    echo $this->Html->Script('withdraw_application');
?>
