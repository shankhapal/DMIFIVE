									...
									<div class="form-horizontal">
										<div class="card-body">
											<div class="row">
												<div class="col-sm-6">
													<div class="form-group row">
													<label for="inputEmail3" class="col-sm-3 col-form-label">AGMARK Certificate No. <span class="cRed">*</span></label>
														<div class="col-sm-9">
                                                ...
                                                <!--New block is added on 05-01-2024 by Amol, to manage hide/show Nabl date and grant date option for lab. export -->
                                                <div id="nabl_dt_field" class="col-sm-6">
													<div class="form-group row">
														<label for="inputEmail3" class="col-sm-3 col-form-label">AGMARK Certificate Validity <span class="cRed">*</span></label>
														<div class="col-sm-9">
															<?php echo $this->Form->control('nabl_val_dt', array('type'=>'text', 'placeholder'=>'Select AGMARK Certificate Validity Date', 'readonly'=>'true', 'id'=>'nabl_val_dt', 'class'=>'form-control input-field', 'label'=>false)); ?>
															<span id="error_nabl_val_dt" class="error invalid-feedback"></span>
														</div>
													</div>
												</div>
											</div>
...
<?php //below code updated on 05-10-2021 by Amol, call external js files
    ...
    //added new script on 05-01-2024 by Amol, to manage the lab. export Nabl date option while adding firm
    echo $this->Html->script('customerforms/add_firm_lab_export_script');
 ?>
