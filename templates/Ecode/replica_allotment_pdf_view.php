...
<style>
	...
	<table  width="100%">
		...
		<tr>
			<td>
				...
				on the subject cited above the E-Code no. <b><?php echo $firm_details['e_code']; ?></b> 
				is allotted for the printing of Agmark replica.
				<br>The following replica E-code is valid till date <b class="bYello"><?php echo $validUptoDate; ?></b>
			</td>
		</tr>
    ...
    <table align="left" style="margin-top: 15px">
        <tr>
            <td>
                As soon as the E-Code replica bearing <?php echo $firm_details['e_code']; ?> are received from the manufacturer/printing presses, they will be handed over to chemist In-charge who will be responsible for maintaining the account of E-Code replica bearing <?php echo $firm_details['e_code']; ?>. <br>
             </td>
         </tr>
         <tr>
             <td>   
                It will be overall responsiblility of the certificate of authorization holder to keep the E-Code replica bearing <?php echo $firm_details['e_code']; ?> in safe custody and the account for the same. <br>
            </td>
        </tr>

        <tr>
             <td>
                The concerned approved printing presses may also be advised to send a copy of this invoice against your order to this office for record. The order placed for the printing AGMARK replica <?php echo $firm_details['e_code']; ?> in lieu of Agmark lables may be endorsed to this office.
            </td>
        </tr>
