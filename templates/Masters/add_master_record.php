...
<div class="content-wrapper">
	...
	<section class="content form-middle">
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-10">
					<!--This changed on the 08-12-2023 and added the type = file by Akash Thakre [08-12-2023]-->
					<?php echo $this->Form->create(null,array('class'=>'form-group','type'=>'file', 'enctype'=>'multipart/form-data','id'=>$form_id)); ?>
						<div class="card">
									...
									<div class="row">
										<?php
											if ($masterId=='1') {
												...
												// For User manual added by akash thakre on 06/11/2023
												echo $this->element('masters_management_elements/add_master_elements/add_manual');
											}
										?>
									</div>
								</div>
