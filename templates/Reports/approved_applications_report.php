	...
	<div class="content-wrapper bg-bg">
		<div class="content-header page-header" id="page-load">
			<div class="container-fluid">
				<div class="row mb-2">
					<div class="col-sm-6">
						<h6 class="m-0 ml-3"><?php if($report_heading == 'Approved Renewal Applications Report') { echo 'Approved Renewal Applications Report'; } else { echo 'Approved New and Old Applications Report';	} ?></h6>
					</div>
					<div class="col-sm-6 my-auto">
						<ol class="breadcrumb float-sm-right">
							...
							<span class=""><i class="fas fa-chevron-right px-2 fs80"></i><span class="badge page-header">
								<?php if($report_heading == 'Approved Renewal Applications Report') { echo 'Approved Renewal Applications Report'; } else { echo 'Approved New and Old Applications Report';	} ?></span>
							</span>
						</ol>
					</div>
							...
							<?php ?> <span class="badge bg-light shadow">RESULT</span><i class="fas fa-chevron-right px-2 fs80"></i> <?php
								...
								?>  <span class="badge rounded-pill bg-grad1 shadow">Application Type</span>
										...
										<span class="badge bg-grad2 mr-3 shadow"> <?php foreach($search_application_type_id as $application_type_id) {
											 $application_type_names[] = $application_type_xy[$application_type_id];
										} echo implode(', ', $application_type_names); $search_value = 'yes'; ?> </span>
									<?php
								}
								...
								?>  <span class="badge rounded-pill bg-grad1 shadow">RO Office</span>
										...
										<span class="badge bg-grad2 mr-3 shadow"> <?php foreach($application_approved_office as $approved_office_id) {
											$ro_office_names[] =   $ro_office[$approved_office_id];
										} echo implode(', ', $ro_office_names); $search_value = 'yes'; ?> </span>
									<?php
								}
