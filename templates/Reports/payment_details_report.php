							...
							<table class="table table-sm rounded" id="payment_details_report_table">
								<thead class="table-light">
									<tr class="rounded">
										...
										<?php if ($report_for == 4) { ?>
											<th><span class="table-heading">Chemist ID</span></th>  
										<?php } else {?>
										<th><span class="table-heading">Firm ID</span></th>  <!-- Added By Vikas 12-09-2023  -->
										<?php } ?>
									...
									if (!empty($firms_details[$j])) { 
										...
										<?php for ($i = 0; $i < sizeof($firms_details[$j]); $i++) { ?>
											...
											<tr id="table_row" class="row-hover border border-light">
												...
												<td><span class="badge title borderless"><?php echo  $customer_payment_details[$j][$i]['customer_id']; 
														   ?></span>
												</td>
												  <!-- Added By Vikas 12-09-2023  -->
		...
		<section class="content form-middle"> 
			<div class="container-fluid border rounded-lg border-light bg-light p-3 shadow hidden  reportCnt">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="table-responsive report-table-format">
							<!-- <table class="table table-bordered" id="payment_details_report_tablse">
								<tbody class="">
