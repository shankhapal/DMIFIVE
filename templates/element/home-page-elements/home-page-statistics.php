...
<div id="multi-item-example" class="carousel slide carousel-multi-item" data-ride="carousel">
    <!--Controls-->
    <!--<div class="controls-top"><a class="btn-floating" href="#multi-item-example" data-slide="prev"><span class="glyphicon glyphicon-chevron-left"></span></a><a class="btn-floating" href="#multi-item-example" data-slide="next"><span class="glyphicon glyphicon-chevron-right"></span></a></div>-->
    <!--/.Controls-->
    <!--Indicators-->
    <!--<ol class="carousel-indicators"><li data-target="#multi-item-example" data-slide-to="0" class="active"></li><li data-target="#multi-item-example" data-slide-to="1"></li><li data-target="#multi-item-example" data-slide-to="2"></li></ol>-->
    <!--/.Indicators-->
    ...
    <div class="backimag">
        ...
        <div class="carousel-inner pd30_0" role="listbox">
                ...
                <div class='offset-md-2 row'>
                    <div class='col-md-2 squaretotal squaretotalr square s14-color'>
                        ...
                        <h1> <?php echo $frontstatisctics['primary_user'] + 
						  $frontstatisctics['firms_registered'] +   $frontstatisctics['dmi_chemist'] + 
						  $frontstatisctics['t_users'] ; ?> </h1>
                    ...
                    <div class='col-md-2 squaretotalr square s12-color'>
                        ...
                        <div class="row text-center">
                            <div class="col-md-12 p-0 "> Firms Registered : <span class="highlight"> <?php echo $frontstatisctics['firms_registered']; ?> </span>
                            </div>
                            <div class="col-md-12 p-0  "> Chemist Registered : <span class="highlight"> <?php echo $frontstatisctics['dmi_chemist']; ?> </span>
                            </div>
                        </div>
                    </div>
                ...
                <div class='offset-md-2 row'>
                    <div class='col-md-2 squaretotal squaretotalr square s24-color'>
                        ...
                        <h1> <?php echo $frontstatisctics['ca_firm_reg'] + 
						  ...
						  $frontstatisctics['lb_firm_reg'] ; ?> </h1>
            ...
            <div class="carousel-item">
                <div class='offset-md-2 row'>
                    <div class='col-md-2 squaretotal squaretotalr square s34-color'>
                        ...
                        <span>Total New Applications Granted </span>
                    </div>
                ...
                <div class='offset-md-2 row'>
                    <div class='col-md-2 squaretotal squaretotalr square s44-color'>
                        ...
                        <h1> <?php echo $frontstatisctics['ca_renew_grant'] + 
							  ...
							  $frontstatisctics['lab_renew_grant'] ; ?> </h1>
            ...
            <div class="carousel-item">
                <div class='offset-md-2 row'>
                    <div class='col-md-2 squaretotal squaretotalr square s61-color'>
                        ...
                        <h1> <?php echo $frontstatisctics['t_chemist'] ; ?> </h1>
            ...
            <div class="carousel-item">
                <div class='offset-md-2 row'>
                    <div class='col-md-2 squaretotal squaretotalr square s54-color'>
                        ...
                        <h1> <?php echo $frontstatisctics['total_revenue'] ; ?> </h1>
                    ...
                    <div class='col-md-2 squaretotalr square s53-color'>
                        ...
                        <h1> <?php echo $frontstatisctics['reve_app_change']; ?> </h1>
            ...
            <div class="carousel-item">
                <div class='offset-md-2 row'>
                    <div class='col-md-2 squaretotal squaretotalr square s64-color'>
                        <div class='circle-icon'>
                            <img src="/writereaddata/home-slider/image/revenue.png" alt="revenu">
                        </div>
                        <h1><?php echo $frontstatisctics['reve_app_chem']; ?></h1>
                        <span>Chemist approval </span>
                    </div>
                    <div class='col-md-2 squaretotalr square s51-color'>
                        <div class='circle-icon'>
                            <img src="/writereaddata/home-slider/image/receive-amount.png" alt="revenu">
                        </div>
                        <h1><?php echo $frontstatisctics['reve_replica_granted']; ?></h1>
                        <span>Replica Granted </span>
                    </div>
                    <div class='col-md-2 squaretotalr square s54-color'>
                        <div class='circle-icon'>
                            <img src="/writereaddata/home-slider/image/wallet.png" alt="revenu">
                        </div>
                        <h1><?php echo $frontstatisctics['reve_app_adv']; ?></h1>
                        <span>Replica Advance </span>
                    </div>
                    <div class='col-md-2 squaretotalr square s53-color'>
                        <div class='circle-icon'>
                            <img src="/writereaddata/home-slider/image/trade.png" alt="revenu">
                        </div>
