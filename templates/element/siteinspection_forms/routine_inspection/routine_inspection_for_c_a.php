                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                     ...
                                                     <?php
                                                    if (!empty($section_form_details[10]) && isset($section_form_details[10]['grading_lab_id'])) {
                                                        $grading_lab_id = $section_form_details[10]['grading_lab_id'];
                                                        echo '<input type="hidden" name="grading_laboratory" id="grading_laboratory" value="' . $grading_lab_id . '">';
                                                    } else {
                                                        echo '<input type="hidden" name="grading_laboratory" id="grading_laboratory" value="">';
                                                    }
                                                    ?>
                                            ...
                                            <div class="col-md-6">
                                                  <?php $i=1;
                                                        ...
                                                        <tbody>
                                      <!-- //////////////////////////////////////////////////
                                                            added new logic for handling error on own lab
                                                            by shankhpal on 03/11/2023
                                    -->
                                                            <?php
                                                            foreach ($section_form_details[4] as $value) { ?>
                                                                <tr>
                                                                    <td><?php echo $i; ?></td>
                                                                     <td><?php echo isset($value['firm_name']) ? $value['firm_name'] : (isset($value['laboratory_name']) ? $value['laboratory_name'] : ''); ?></td>
                                                                </tr>
                                                            <?php $i++; }}else{ ?>
                                                     ...
                                                     <ol class="badge mt-2">
                                                    <a target="_blank" href="/writereaddata/DMI/manuals/applicant/Manual_mapping_lab_pp.pdf">Manual for Mapping of CA With Lab/Printing Press</a>
                                                </ol>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body border">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <ol class="badge">
                                                    <a target="_blank" href="/writereaddata/DMI/manuals/applicant/Chemist Registration.pdf">Manual for Chemist Registeration</a>
                                                </ol>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body border">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                        <div class="col-sm">
                                                    <?php echo $this->Form->control('shortcomings_noticed', array('type'=>'textarea', 'id'=>'shortcomings_noticed','placeholder'=>'Shortcomings noticed','class'=>'form-control', 'maxlength'=>"300", 'label'=>false,'value'=>isset($section_form_details[0]['shortcomings_noticed'])?$section_form_details[0]['shortcomings_noticed']:"")); ?>
                                                    <span id="error_shortcomings_noticed" class="error invalid-feedback"></span>
                                                    <div id="charCount" class="charCountRed text-right" >
                                                    Character count: 300
                                                </div>
                                                </div>
...
<!-- //added new line for handling array to string conversion by shankhpal on 03/11/2023 -->
<!-- <input type="hidden" id="final_submit_status_id" value="<?php //echo implode(',', $final_submit_status); ?>"> -->
...
echo $this->Html->script('routininspection/routin_inspection01');
