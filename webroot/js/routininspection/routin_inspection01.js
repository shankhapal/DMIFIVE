...
//   var maxLength = 300;
  ...
  function charactorCountFlag(){
    var maxCharacters = 300; // Maximum character limit
    var tweetInput = $("#shortcomings_noticed");
    ...
    charCount.text("Character count: " + remainingCharacters+ "/"+ maxCharacters);

    // Check if the character limit is exceeded
    if (remainingCharacters <= 0) {
        charCount.addClass("cred");
      //  $('#shortcomings_noticed').text('');
    } else {
        charCount.removeClass("cred");
        // $('#shortcomings_noticed').text('');
    }

  }
  var tweetInput = $("#shortcomings_noticed");
  tweetInput.on("input", charactorCountFlag);
...
function routineInspectionFormValidation() {
  ...
  if (firm_type == 1) {
    var date_p_inspection = $("#date_p_inspection").val();
    var time_p_inspection = $("#time_p_inspection").val();
    ...
    var replica_account_correct_yes = $("#replica_account_correct-yes").val()
    var value_return = "true";
    ...
    // added new validation on 01-02-2024 by shankhpal
////////////////////////////////////////////////////////////////////
    if ($("#replica_account_correct-no").is(":checked")) {
